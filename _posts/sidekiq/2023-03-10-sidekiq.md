...
{% include image.html url="https://olegchuev.github.io/blog/assets/images/sidekiq/redis.png" description="How is REDIS traditionally used. Image was taken from the https://architecturenotes.co/redis/" %}
